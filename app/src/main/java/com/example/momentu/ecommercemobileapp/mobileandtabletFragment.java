...
public class mobileandtabletFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView= inflater.inflate(R.layout.fragment_mobileandtablet,container,false);
        recyclerView=rootView.findViewById(R.id.recycler_mobandtab);
...
/*
        productRef.orderByChild("category")
*/
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions<prodcuts> options=new FirebaseRecyclerOptions.Builder<prodcuts>().setQuery(productRef.orderByChild("category").equalTo("mobileCat"),prodcuts.class).build();

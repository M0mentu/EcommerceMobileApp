...
public class electronicsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView=rootView.findViewById(R.id.recycler_electronic);
...
*/
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions<prodcuts> options=new FirebaseRecyclerOptions.Builder<prodcuts>().setQuery(productRef.orderByChild("category").equalTo("electronicsCat"),prodcuts.class).build();
